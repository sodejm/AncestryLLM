...
This work adds no Electron bridge, renderer chat, streaming, or generic provider
route; those residual boundaries remain owned by #111, #112, and #131.
...
Structured output remains on the validated `generate()` path. No API, Electron,
renderer, or public stream surface is introduced; end-to-end streaming remains
#111 and packaged adversarial evidence remains #131.
...
| `G1 — Privileged boundaries` | #11, #102, #100, #101, #103, #104, #105, #108, and #110 pass pre-parse authentication, exact-host/version, sender/origin, CSP/fuse, secret non-retrieval, grant/race, event/cancellation, profile/consent revalidation, provider bounds, redaction, and supervision tests. |

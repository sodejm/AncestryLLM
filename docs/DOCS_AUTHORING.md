...
| `ADR-0027-core-extraction-decision.md` | Supporting/control: architecture decision | `docs/ADR-0027-core-extraction-decision.md` | Retain | Maintainers | Accepted CORE-42 decision record | Core extraction policy | Understand standalone extraction decision rule outcomes | GEDCOM extraction decision; RootsMagic extraction decision | GEDCOM and RootsMagic extraction decision ADR | Records separate GEDCOM and RootsMagic extraction decisions, evidence summary, and measurable revisit triggers. | Retain basename; no redirect needed |

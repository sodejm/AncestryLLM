...
| `ADR-0027-core-package-extraction-decision.md` | Supporting/control: architecture decision | `docs/ADR-0027-core-package-extraction-decision.md` | Retain | Maintainers | Accepted extraction decision | Core architecture | Understand package extraction disposition | GEDCOM extraction decision; RootsMagic extraction decision | Core package extraction decision ADR | Records the accepted #170 decision to keep GEDCOM and RootsMagic internal until measurable extraction triggers are met. | Retain basename; no redirect needed |

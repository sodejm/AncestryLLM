...
| `how-to/desktop-rootsmagic-workbench.md` | How-to guide | `docs/how-to/desktop-rootsmagic-workbench.md` | Create in #119; retain basename | Desktop users and maintainers | Source-level native workbench; packaged acceptance pending | RootsMagic workbench | Browse immutable sources and export rooted trees | desktop RootsMagic; preset queries; atomic export folder | Use the RootsMagic workbench | Explains source selection, bounded browsing, rooted export, cancellation, and reauthorization. | Retain unique basename; validated in flat Wiki namespace |
...
| `release-notes/0.7.0-rootsmagic-workbench.md` | Supporting/control: release note | `docs/release-notes/0.7.0-rootsmagic-workbench.md` | Create in #119 | Users and release maintainers | Development record; packaged acceptance pending | Release notes | Review RootsMagic workbench scope and limitations | RootsMagic workbench release notes | RootsMagic workbench development notes | Records native workbench implementation and outstanding packaged acceptance. | Retain versioned pathname |

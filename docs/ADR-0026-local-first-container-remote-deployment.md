...
| #108 | Profiles and consent are explicit, endpoint-bound, transactional, and never inferred. | Source and packaged settings flow plus #110's bounded source-level chat execution are implemented; Electron presentation and target-matched network evidence remain #111/#112/#131. |

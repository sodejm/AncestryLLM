...
| #108 | Profiles and consent are explicit, endpoint-bound, transactional, and never inferred. | Source and packaged settings flow plus #110's bounded chat execution and #111's private streaming transport are implemented; renderer presentation and target-matched network evidence remain #112/#131. |

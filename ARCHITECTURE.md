...
adapter exposes five fixed submission routes and one fixed result route over
that façade. CLI and REPL adapters compose the same request DTOs and call the

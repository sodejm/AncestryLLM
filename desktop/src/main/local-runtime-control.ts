...
const remediations: Readonly<Record<BridgeErrorCode, string>> = {
  ...
  GEDCOM_INTAKE_INVALID: 'Select the GEDCOM file again and retry the inspection.',
  GEDCOM_INTAKE_CAPACITY: 'Finish or discard another GEDCOM inspection and try again.',
  GEDCOM_JOB_RESULT_UNAVAILABLE: 'Run the GEDCOM inspection again.',
  GEDCOM_ROOT_CURSOR_INVALID: 'Reload the GEDCOM root candidates and try again.',
  ...
  CHAT_SESSION_INVALID: 'Review the provider, model, data classes, and consent before trying again.',
  CHAT_SESSION_NOT_FOUND: 'Reload the conversation and try again.',
  CHAT_SESSION_LIMIT: 'Close another conversation before trying again.',
  CHAT_SESSION_BUSY: 'Wait for the current response to finish or cancel it before trying again.',
  CHAT_SESSION_SERVICE_UNAVAILABLE: 'Retry the private service or restart AncestryLLM.',
